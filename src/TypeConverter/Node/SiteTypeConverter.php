...
class SiteTypeConverter implements TypeConverterInterface {
	...
	public function convert($source) {
		if ($this->isUpdate($source)) {
			return $this->getUpdatedSite($source);
		}
		return $this->getNewSite($source);
	}
	 ...
	 * @return Site
	 */
	protected function getNewSite(array $source) {
		$node = new Site();
	 ...
	 * @return Site
	 */
	protected function getUpdatedSite(array $source) {
