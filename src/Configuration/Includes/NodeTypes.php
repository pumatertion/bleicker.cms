...
Site::register('site', 'Website', 'The root page of a domain', NodeConfiguration::SITE_GROUP, PageNodeInterface::class, ContentNodeInterface::class);

/** Register Pages */
Page::register('page', 'Page', 'A simple page', NodeConfiguration::PAGE_GROUP, PageNodeInterface::class, ContentNodeInterface::class);
...
GridElement::register('gridelement', 'Grid-Element', 'A Grid-Element', NodeConfiguration::CONTENT_GROUP, ContentNodeInterface::class);
